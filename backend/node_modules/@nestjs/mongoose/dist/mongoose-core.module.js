...
let MongooseCoreModule = MongooseCoreModule_1 = class MongooseCoreModule {
    ...
    static forRoot(uri, options = {}) {
        ...
        const connectionProvider = {
            ...
            useFactory: () => __awaiter(this, void 0, void 0, function* () {
                return yield rxjs_1.defer(() => __awaiter(this, void 0, void 0, function* () { return mongoose.createConnection(uri, mongooseOptions); }))
    ...
    static forRootAsync(options) {
        const mongooseConnectionName = options.connectionName
            ? mongoose_utils_1.getConnectionToken(options.connectionName)
            : mongoose_constants_1.DEFAULT_DB_CONNECTION;
        const mongooseConnectionNameProvider = {
            provide: mongoose_constants_1.MONGOOSE_CONNECTION_NAME,
            useValue: mongooseConnectionName,
        ...
        const connectionProvider = {
            ...
            useFactory: (mongooseModuleOptions) => __awaiter(this, void 0, void 0, function* () {
                const { retryAttempts, retryDelay, connectionName, uri } = mongooseModuleOptions, mongooseOptions = __rest(mongooseModuleOptions, ["retryAttempts", "retryDelay", "connectionName", "uri"]);
                return yield rxjs_1.defer(() => __awaiter(this, void 0, void 0, function* () {
                    return mongoose.createConnection(mongooseModuleOptions.uri, mongooseOptions);
                }))
